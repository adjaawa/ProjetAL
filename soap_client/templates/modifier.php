    ...
    <div class="container conteneur">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-9 section-2"> 
                ...
                <br>
                <form class="form-horizontal" action="http://localhost:5000/modifier" method="POST">

                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Prenom</label>
                        <div class="col-sm-5">
                        <input type="text" class="form-control" name="prenom" id="" placeholder="" value="{{ user['prenom'] }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Nom</label>
                        <div class="col-sm-5">
                        <input type="text" class="form-control" name="nom" id="" placeholder="" value="{{ user['nom'] }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Email</label>
                        <div class="col-sm-5">
                        <input type="email" class="form-control" name="email" id="" placeholder="" value="{{ user['email'] }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Nom d'utilisateur</label>
                        <div class="col-sm-5">
                        <input type="text" class="form-control" name="username" id="" placeholder="" value="{{ user['username'] }}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-default">Modifier Utilisateur</button>
                        </div>
                    </div>
                </form>
