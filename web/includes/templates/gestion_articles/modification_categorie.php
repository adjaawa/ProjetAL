<div class="container">
    <div class="row">
        ...
        <div class="col-md-9 section-2"> 
            ...
            <form class="form-horizontal" action="index.php?modification_article=1&update=1" method="POST">
            ...
            <form class="form-horizontal" action="index.php?modification_article=1&delete=1" method="POST">
